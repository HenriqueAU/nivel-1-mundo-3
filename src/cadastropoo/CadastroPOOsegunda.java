...
public class CadastroPOOsegunda {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        switch(input){
            ...
            case(2) -> {
                ...
                if(pessoaTipoA.equals("F")){
                    ...
                    try{
                        ...
                        pessoaFisicaRepo.alterar(pessoaAlterar, pessoaFNova);
                        pessoaAlterar.exibir();
                    ...
                    try{
                        ...
                        pessoaJuridicaRepo.alterar(pessoaAlterar, pessoaJNova);
                        pessoaAlterar.exibir();
                        System.out.print("Dados alterados com sucesso.");
                    }catch(Throwable e){
                        System.out.println("Erro ao obter dados: " + e.getMessage());
            ...
            default -> System.out.println("Escolha uma opção entre 0 a 7.");
        }
        }while(true);
